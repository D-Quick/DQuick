module dquick.item.columnRepeaterItem;
...
class ColumnRepeaterItem : GraphicItem, dquick.script.iItemBinding.IItemBinding
{
...
public:
	...
	// ID
	dquick.script.nativePropertyBinding.NativePropertyBinding!(string, ColumnRepeaterItem, "id")	idProperty;
	override string	id() { return DeclarativeItem.id(); }
	override void	id(string value) { return DeclarativeItem.id(value); }

	// Model
	dquick.script.nativePropertyBinding.NativePropertyBinding!(LuaValue, ColumnRepeaterItem, "model")	modelProperty;
	...
	// Delegate
	dquick.script.delegatePropertyBinding.DelegatePropertyBinding!(GraphicItem delegate(), ColumnRepeaterItem, "itemDelegate")	itemDelegateProperty;
